...
class TikTokExtractor : VideoExtractor {
     ...
     * Also verifies the returned URL is actually downloadable.
     */
    private fun tryTikWmApi(url: String): VideoInfo? {
        return try {
            ...
            // If verification fails or returns HTML, skip
            if (verifyCode !in 200..299 && verifyCode != 206) return null
            if (verifyContentType.contains("text/html")) return null
    ...
    /**
     * Try to get thumbnail URL from TikTok oEmbed API.
     */

...
- تحميل فيديوهات TikTok **بدون علامة مائية** عبر لصق الرابط
- نظام استخراج متعدد المصادر (tikwm → ssstik.io → cobalt → oEmbed → HTML)
- كشف تلقائي لمنشورات الصور/السلايد شو (مع رسالة خطأ واضحة)
- فحص بايتات الملف لضمان تحميل فيديو صالح (رفض JPEG/PNG/GIF)
